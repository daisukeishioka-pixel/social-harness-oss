...
**SNS統合管理プラットフォーム** — Instagram, YouTube, Threads, TikTok を一元管理。投稿・分析・AIアシスタントを統合したオープンソースのSNSマーケティングツール。

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)

**Demo:** [https://social-harness.vercel.app](https://social-harness.vercel.app)

<!-- スクリーンショット -->
### ダッシュボード
![Dashboard](docs/screenshots/dashboard.png)
<!-- ↑ docs/screenshots/dashboard.png にスクリーンショットを配置してください -->

### 投稿スケジューラー
![Scheduler](docs/screenshots/scheduler.png)
<!-- ↑ docs/screenshots/scheduler.png にスクリーンショットを配置してください -->

### AI投稿提案
![AI Suggestions](docs/screenshots/ai-suggestions.png)
<!-- ↑ docs/screenshots/ai-suggestions.png にスクリーンショットを配置してください -->

### 設定画面
![Settings](docs/screenshots/settings.png)
<!-- ↑ docs/screenshots/settings.png にスクリーンショットを配置してください -->
...
| **TikTok** | 動画アップロード | 再生数・いいね・コメント・シェア | ✅ |
